---
title: Scaffolding Industrial Edge on East and West
weight: 8
---

# Scaffolding Industrial Edge on East and West

Developer Hub **Create** templates deploy new Industrial Edge instances to **east** or **west** spokes. This chapter is the operational follow-up to [Architecture](architecture.md) and [Getting Started](getting-started.md).
...
**Next →** [Hub Gateway](hub-gateway.md) for cross-cluster HTTP routing, or [Observability](observability.md) to confirm metrics after workloads are running.
